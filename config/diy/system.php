...
return [
    'session_key_admin' => 'LNCPyCUm6GaCiEnw6I2rcxkPiWKvzkuZ9qhiAQBS',  //主后台session key
    'pass_key' => 'd88bBXztPXG65MLvdcaJrtvYkdJUBG7yF0aKQ2zk',  //密码的盐
    'reset_pass_key' => 'ws2Eq3Sjl0BWSLanEHLpHE9dIAI6oneI0tqBdLSH',  //重置密码的密钥
    ...
    'wxpay_app_id' => '',  //微信支付AppID
    'wxpay_app_secret' => '',  //微信支付AppSecret
...
<p>支付方式：{payment}</p>',  //订单提醒邮件内容
    ...
    'mail_pay_content' => '<p>您的订单尚未支付，请及时支付，支付链接：<a href="{pay_url}" target="_blank">{pay_url}</a>。</p>
<p>订单详情</p>
<p>订 单 号：{order_id}</p>
<p>订购商品：{product_name}</p>
<p>商品属性：{product_attr}</p>
