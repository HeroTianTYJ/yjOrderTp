...
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('57','合并','','merge','0','56');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('58','打包','','zip','0','56');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('59','下载','','download','0','56');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('60','删除','','delete','0','56');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('61','行政区划','District','index','0','0');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('62','添加','','add','0','61');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('63','批量添加','','multi','0','61');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('64','修改','','update','0','61');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('65','删除','','delete','0','61');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('66','管理员','Manager','index','0','0');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('67','添加','','add','0','66');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('68','修改','','update','0','66');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('69','删除','','delete','0','66');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('70','激活','','isActivation','0','66');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('71','解绑微信','','wechatOpenId','0','66');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('72','解绑QQ','','qqOpenId','0','66');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('73','登录记录','LoginRecordManager','index','0','0');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('74','导出并清空','','output','0','73');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('75','权限组','PermitGroup','index','0','0');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('76','添加','','add','0','75');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('77','修改','','update','0','75');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('78','删除','','delete','0','75');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('79','设置默认','','isDefault','0','75');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('80','管理权限','PermitManage','index','0','0');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('81','设置默认','','isDefault','0','80');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('82','数据权限','PermitData','index','0','0');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('83','设置默认','','isDefault','0','82');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('84','系统设置','System','index','0','0');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('85','生成验证文件','ValidateFile','index','0','0');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('86','SMTP服务器','Smtp','index','0','0');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('87','添加','','add','0','86');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('88','修改','','update','0','86');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('89','删除','','delete','0','86');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('90','运行状态','','state','0','86');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('91','数据表状态','Database','index','0','0');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('92','优化表','','optimize','0','91');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('93','修复AutoIncrement','','repairAutoIncrement','0','91');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('94','更新表缓存','','schema','0','91');
INSERT INTO `yjorder_permit_manage`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`) VALUES('95','数据库备份','DatabaseBackup','index','0','0');
