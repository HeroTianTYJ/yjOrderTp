...
function listItem (item) {
  return '<tr class="item' + item['id'] + '"><td>' + item['ip'] + '</td><td><a href="' + item['url'] + '" target="_blank" title="' + item['url'] + '">' + item['truncate_url'] + '</a></td><td>' + item['count'] + '</td><td>' + item['create_time'] + '</td><td>' + item['last_visit_time'] + '</td></tr>';
}
